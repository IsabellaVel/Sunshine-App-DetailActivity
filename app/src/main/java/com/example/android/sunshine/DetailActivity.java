...
//      TODO (21) Implement LoaderManager.LoaderCallbacks<Cursor>
    ...
    public static final int ID_DETAIL_LOADER = 104;
...
//      TODO (13) Find each of the TextViews by ID
        ...
        mWeatherDescription = (TextView) findViewById(R.id.tv_description);
        mWeatherHighTemperature = (TextView) findViewById(R.id.tv_high_temperature);
        mWeatherLowTemperature = (TextView) findViewById(R.id.tv_low_temperature);
...
//      TODO (27) Display the weather description (using SunshineWeatherUtils)
        int idWeather = data.getInt(INDEX_WEATHER_CONDITION_ID);
        String weatherDescription = SunshineWeatherUtils.getStringForWeatherCondition(this, idWeather);
        mWeatherDescription.setText(weatherDescription);

//      TODO (28) Display the high temperature
//      TODO (29) Display the low temperature

        double highTemperatureDisplay = data.getDouble(INDEX_WEATHER_MAX_TEMP);
        String highTemperature = SunshineWeatherUtils.formatTemperature(this, highTemperatureDisplay);
        mWeatherHighTemperature.setText(highTemperature);

        double lowTemperatureDisplay = data.getDouble(INDEX_WEATHER_MAX_TEMP);
        String lowTemperature = SunshineWeatherUtils.formatTemperature(this, lowTemperatureDisplay);
        mWeatherLowTemperature.setText(lowTemperature);
...
//      TODO (32) Display the pressure
        float weatherPressure = data.getFloat(INDEX_WEATHER_PRESSURE);
        String pressureString = getString(R.string.format_pressure, weatherPressure);
        mWeatherPressure.setText(pressureString);

//      TODO (33) Store a forecast summary in mForecastSummary
        mForecastSummary = String.format("%s - %s - %s/%s", dateText, weatherDescription, highTemperature, lowTemperature);
